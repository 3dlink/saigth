    ...
    <fieldset>
      ...
      <div class="margenesHorizontales">
	        ...
	        <div class="form-group">
	          <label>Nombre</label>
	          <?php echo $this->Form->input('nombre',array('div'=>false, 'required'=>true,'label'=>false,'class'=>'form-control', 'required'=>true,'placeholder'=>'Nombre')); ?>
	        </div>
	      </div>
	        ...
	        <div class="form-group">
	          ...
	          <?php echo $this->Form->input('nivel_academico',array('div'=>false, 'required'=>true,'label'=>false,'class'=>'form-control','placeholder'=>'Nivel académico', 'required'=>true)); ?>
	        </div>
				</div>
